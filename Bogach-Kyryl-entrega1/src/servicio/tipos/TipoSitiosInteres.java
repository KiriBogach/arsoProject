 ...
 *       &lt;sequence>
 *         &lt;element name="sitio" type="{http://www.example.org/ciudad}tipoIdentificador" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TipoSitiosInteres {
    ...
    protected List<TipoIdentificador> sitio;
     ...
     * 
     */
    public List<TipoIdentificador> getSitio() {
        if (sitio == null) {
            sitio = new ArrayList<TipoIdentificador>();
        }
        return this.sitio;
    }
