 ...
 *       &lt;sequence>
 *         &lt;element name="sitio" type="{http://www.example.org/ciudad}tipoSitioInteres" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TipoSitiosInteres {
    ...
    protected List<TipoSitioInteres> sitio;
     ...
     * {@link TipoSitioInteres }
     * 
     * 
     */
    public List<TipoSitioInteres> getSitio() {
        if (sitio == null) {
            sitio = new ArrayList<TipoSitioInteres>();
        }
        return this.sitio;
    }
